<div id="section_<?php echo $section_name; ?>" class="sv_content_wrapper">
	<div class="sv_content">
		...
		<code>$section['object']->get_current_url();</code>
		...
		<code>$section['object']->get_root()->get_name();</code>
		...
		<code>$section['object']->get_name();</code>
		...
		<code>$section['object']->get_module_name();</code>
		...
		<code>$section['object']->get_prefix($append='');</code>
		...
		<code>$section['object']->get_relative_prefix($append='');</code>
		...
		<code>$section['object']->get_url_lib_core($suffix='',$check_if_exists=false);</code>
		...
		<code>$section['object']->acp_style($hook=false);</code>
		...
		<code>$section['object']->get_path_lib($suffix='',$check_if_exists=false);</code>
		<blockquote><?php echo $section['object']->get_path_lib(); ?></blockquote>
		<code>$section['object']->get_url_lib($suffix='',$check_if_exists=false);</code>
		<blockquote><?php echo $section['object']->get_url_lib(); ?></blockquote>
		<code>$section['object']->get_path_lib_modules();</code>
		<blockquote><?php echo $section['object']->get_path_lib_modules(); ?></blockquote>
		<code>$section['object']->get_path_lib_section($section=false,$dir=false,$suffix='',$check_if_exists=false);</code>
		<blockquote><?php echo $section['object']->get_path_lib_section(); ?></blockquote>
		<code>$section['object']->get_url_lib_section($section=false,$dir=false,$suffix='',$check_if_exists=false);</code>
