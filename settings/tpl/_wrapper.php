    ...
    <div class="sv_setting_header">
		...
		<?php if($this->get_is_responsive()){ ?>
            ...
            <div class="sv_setting_responsive_select">
                ...
                <i class="fas fa-tablet-alt" data-sv_setting_responsive_select="tablet_pro"></i>
                <i class="fas fa-tablet-alt fa-rotate-90" data-sv_setting_responsive_select="tablet_pro_landscape"></i>
