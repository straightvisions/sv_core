...
jQuery( document ).on( 'click','.sv_setting_group_add_new_button', function() {
    ...
    if ( color_settings && typeof sv_core_color_picker !== 'undefined' ) {
        color_settings.each( function() {
            ...
            const id = el.attr('id').replace("sv_form_field_index", index );
...
jQuery( document ).ready( function() {
    if ( SVColorPicker && typeof sv_core_color_picker !== 'undefined' ) {
    	console.log(sv_core_color_picker);
