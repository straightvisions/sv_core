	...
	class core extends sv_abstract {
		...
		public function load_core_scripts() {
			if($this->is_theme_instance() === false){
				...
				$this->get_root()->get_script( 'sv_core_admin_navigation_responsive' )
				     ->set_path( $this->get_path_core( '../assets/admin_navigation_responsive.js' ), true, $this->get_url_core( '../assets/admin_navigation_responsive.js' ) )
				     ->set_is_backend()
				     ->set_is_enqueued()
				     ->set_is_no_prefix()
				     ->set_type( 'js' )
				...
				$this->get_root()->get_script( 'sv_core_admin_responsive_copy' )
				     ->set_path( $this->get_path_core( '../assets/admin_responsive_copy.js' ), true, $this->get_url_core( '../assets/admin_responsive_copy.js' ) )
				     ->set_is_backend()
				     ->set_is_enqueued()
				     ->set_is_no_prefix()
				     ->set_type( 'js' )
				...
				$this->get_root()->get_script( 'sv_core_color_picker' )
					->set_is_no_prefix()
					->set_path( $this->get_path_core( 'settings/js/sv_color_picker/dist/sv_color_picker.min.js' ), true, $this->get_url_core( 'settings/js/sv_color_picker/dist/sv_color_picker.min.js' ) )
					->set_type( 'js' )
