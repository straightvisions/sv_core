	...
	class core extends sv_abstract {
        ...
        public function load_core_scripts() {
            ...
            $this->get_root()->get_script( 'sv_core_color_picker' )
                ->set_is_no_prefix()
                ->set_path( $this->get_path_core( 'settings/js/sv_color_picker/sv_color_picker_min/sv_color_picker.min.js' ), true, $this->get_url_core( 'settings/js/sv_color_picker/sv_color_picker_min/sv_color_picker.min.js' ) )
                ->set_type( 'js' )
