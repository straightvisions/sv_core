		...
		class abstract_template_sv_archive{
			...
			protected function init($instance, string $setting_prefix): abstract_template_sv_archive{
				$this->parts		= array(
					...
					'sidebar_top'			=> array(
						'loaded'			=> false,
						'label'				=> __('Sidebar Top', 'template_sv_archive_list')
					),
					'sidebar_right'			=> array(
						'loaded'			=> false,
						'label'				=> __('Sidebar Right', 'template_sv_archive_list')
					),
					'sidebar_bottom'		=> array(
						'loaded'			=> false,
						'label'				=> __('Sidebar Bottom', 'template_sv_archive_list')
					),
					'sidebar_left'			=> array(
						'loaded'			=> false,
						'label'				=> __('Sidebar Left', 'template_sv_archive_list')
					),
